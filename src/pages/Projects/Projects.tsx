...
function Projects() {
    ...
    const projects: ProjectData[] = [
        ...
        {
            title: 'Mosaic',
            description: 'Based off of r/Place, Mosaic allows users to place individual tiles on a board to slowly create art. Built using React, along with Socket.io and PostgreSQL for the back-end',
